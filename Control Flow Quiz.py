...
tot_names = []
for year, list_names in nominated.items():
    for names in list_names:
        tot_names.append(names)

tot_names = list(set(tot_names))
tot_names.sort()

for director in tot_names:
    nom_count_dict[director] = 0
...
for director in tot_names:
    win_count_dict[director] = 0

for director in tot_names:
    for year2, winner in winners.items():
        if director in winner:
